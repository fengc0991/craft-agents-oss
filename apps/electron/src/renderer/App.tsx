...
export default function App() {
  ...
  useEffect(() => {
    ...
    const handoffEventTypes = new Set(['complete', 'error', 'interrupted', 'typed_error', 'file_generated', 'session_status_changed', 'session_flagged', 'session_unflagged', 'name_changed', 'labels_changed', 'title_generated', 'async_operation'])
